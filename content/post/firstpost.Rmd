...
Oh guys we admitted it already in the results that the model is more or less crappy as far as predicting precise scores. This reflects the complexity of the issue and the incredible amount of randomness in the result: who would have bet that Roma will have beaten Livelpool 4-2? Maybe it's better if we go back to the old school way (i.e. applying for grants) rather than trying to fund our future Post-docs with money won gambling. 
